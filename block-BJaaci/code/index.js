...
console.log(movies[1].actors[movies[1].actors.length-1]);
...
console.log(movies[0].year>2017&&movies[1].year>2017&&movies[2].year>2017=="Natalie Portman"?true:false)
...
for(let i=0;i<movies.length;i++)
  for(let j=0;j<movies[i].genres.length;j++)
    {
      movies[i].genres.length>1?countg++:"";
    }
console.log(countg);
...
for(let i=0;i<movies.length;i++)
  for(let j=0;j<movies[i].actors.length;j++)
    {
      movies[i].actors.length>1?counta++:"";
    }
...
for(let i=0;i<movies.length;i++)
  for(let j=0;j<movies[i].actors.length;j++)
    {
      movies[i].actors.length==3?console.log(movies[i].title):"";
    }

console.log(count3);
// 30. Log the name of all the movies with year `2018`
for(i in movies){
  movies[i].year==2018?console.log(movies[i].title):"";
}