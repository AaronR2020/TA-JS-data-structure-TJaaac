...
console.log(character.characterName="Arya");
...
console.log(character["character-age"]=age);
...
console.log(character["sur name"]="Stark");
...
console.log(`is famale? : ${character.isFemale}`)
...
console.log(character.isAdult);
character.methods=()=>{return !character.isAdult;}
character.isAdult=character.methods();
    console.log(character.isAdult);
...
character.totalSeasons=character.totalSeasons.split("+");
let sum=0;
for(let i=0;i<character.totalSeasons.length;i++){
    sum+=Number(character.totalSeasons[i]);
}
console.log(
`total seasons are ${sum}`
);
